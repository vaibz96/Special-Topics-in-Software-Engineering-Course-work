...
@date: 03/24/2019
@time: 08:29:11 PM
This code is to practice the date time module, reading comma separated files, and scanning directories
"""
...
class ScanDirectory(unittest.TestCase):
    def test_scan_directory(self):
        ...
        expected = [('C:\\Users\\shanb\\PycharmProjects\\ 810 SSW\\0_defs_in_this_file.py', 0, 0, 3, 57),
                    ...
                    ('C:\\Users\\shanb\\PycharmProjects\\ 810 SSW\\hello.py', 0, 0, 20, 354),
                    ...
                    ('C:\\Users\\shanb\\PycharmProjects\\ 810 SSW\\Homework_08_Vaibhav.py', 2, 6, 143, 5749)]
...
class FileReader(unittest.TestCase):
    def test_file_reader(self):
        ...
        for name, cwid, major in file_reader("file.txt", 3, sep='|', header=True):
            wow.append(
                ["name: {} cwid: {} major: {}".format(name, cwid, major)])
