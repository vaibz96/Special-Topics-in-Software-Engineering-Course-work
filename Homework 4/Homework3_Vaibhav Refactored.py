...
multiplication, and division and is refactored to make it more simplified.
"""
...
class FractionTest(unittest.TestCase):
    ...
    def test_simplify(self):
        ...
        self.assertTrue(str(Fraction(9, 30).simplify()) == str(Fraction(3, 10)))
        self.assertTrue(str(Fraction(3, 9).simplify()) == str(Fraction(1, 3)))
        self.assertTrue(str(Fraction(-3, -9).simplify()) == str(Fraction(1, 3)))
        self.assertTrue(str(Fraction(-1, 3).simplify()) == str(Fraction(1, -3)))
        self.assertTrue(str(Fraction(9, -24).simplify()) == str(Fraction(-3, 8)))
